...
CONFIG_FILE = f"../configs/faster_rcnn/faster_rcnn_r50_fpn_1x_ssdd_assigns.py"
RESULT_FILE = f"../work_dirs/faster_rcnn_r50_fpn_1x_ssdd_assigns0.55/result.pkl"
...
def plot_pr_curve(config_file, result_file, metric="bbox"):
    ...
    pd_data = pd.DataFrame(pr_array1, columns=['filename'])
    pd_data.to_csv('pd_data_cls.csv')
